...
class AuthServiceTest {
	...
	void setUp() {
		...
		appleTokenVerifier = new AppleTokenVerifier("bhanageviraj.Yuti", false);
	...
	void signInWithAppleCreatesSessionForNewUser() {
		...
		request.setIdentityToken(fakeAppleToken("apple-sub-1", "bhanageviraj.Yuti", "ada@example.com"));
